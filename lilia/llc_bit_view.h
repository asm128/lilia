...
namespace llc
{
	...
	public:
		...
		template <size_t _elementCount>
		inline constexpr												bit_view					(_tElement (&_dataElements)[_elementCount], uint32_t elementCount)						: Data(_dataElements), Count(::llc::min(_elementCount * ELEMENT_BITS, elementCount))	{
	...
	::llc::error_t													reverse						(::llc::bit_view<_tField>& toReverse)													{
