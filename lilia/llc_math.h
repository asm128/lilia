...
#ifndef LLC_MATH_H_0237409283740982740928374
#define LLC_MATH_H_0237409283740982740928374
...
#pragma pack(push, 1)	// You can read about pragma pack() here: https://www.google.com/search?q=pragma+pack
	...
	static constexpr		const double			math_pi_180				= ::llc::math_pi / 180.0;				// Pi / 180.0
	...
	template<typename _tNumber>	
	static inline constexpr	_tNumber				clamp					(const _tNumber _value, const _tNumber _min, const _tNumber _max)			noexcept	{ return ::llc::min(_max, ::llc::max(_min, _value));	}
...
#endif // LLC_MATH_H_0237409283740982740928374
