#include "llc_typeint.h"	// for uint16_t and uint32_t 

#ifndef LLC_ASCII_COLOR_H_230487298374
#define LLC_ASCII_COLOR_H_230487298374
...
namespace llc
{
	...
	// 3-Channel color array with a max value of 0xFF each. This means we use 24 bit for each color but as there is no fundamental type of 24-bit in C++ we llcose the next larger, in this case an unsigned int of 32-bit size.
...
#endif // LLC_ASCII_COLOR_H_230487298374
