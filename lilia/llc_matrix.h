...
#ifndef LLC_MATRIX_H_298374982374
#define LLC_MATRIX_H_298374982374
...
namespace llc 
{
	...
	struct SMatrix4 {
		...
		//}
			...
			*this									= 
			...
			::llc::SPairSinCos							angleSinCos					= ::llc::getSinCos(angle);
		...
		//	return *this;
			...
			_44										= (_tBase)1;
							...
							void				SetOrientation				(const ::llc::SQuaternion<_tBase>& qo)																	{
	...
	template<typename _tElement>
							STriangle3D<_tElement>&						transform								(::llc::STriangle3D<_tElement>& triangle, const ::llc::SMatrix4<_tElement>& transform)									{
